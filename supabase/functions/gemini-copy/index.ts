...
const PROMPTS: Record<Kind, string> = {
  why_this: `Ти пишеш одне коротке речення (максимум 12 слів) українською — рядок "чому саме це" для конкретної події у застосунку "Поруч". На вході — профіль ветерана + одна подія.
